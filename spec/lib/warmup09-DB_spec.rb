...
# From warmup #8, we have a program that will load games
# from a file.
#
# Copy your warmup08.rb to warmup09.rb for this exercise.
#
# Add a potential_solutions method that will return an
# array of possible solutions for that cell.
#
# Example:
#   game = SudokuSolver.new
#   game.load_game('sudoku.txt', 1)
#   game.potential_solutions(0,0)    # => [1,4,5]
#
# We'll be spending a couple warmups on this, so just get the
# potential_solutions method working
#
